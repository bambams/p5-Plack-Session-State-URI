...
<style type="text/css" data-breaking-attribute='<form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>'></form>'>
    /*css <form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form> */
</style>
<script type="text/javascript" data-breaking-attribute='<form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>'>
    <!--
    var html = "<form id=\"fake\">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>";
    // <form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>
    /*js <form id="fake">
...
<form id="real" data-breaking-attribute='<form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>'>
    <!-- <form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form> -->
    <label for="name" data-breaking-attribute='<form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>'>Name:</label>
    <input type="text" id="name" name="name" data-breaking-attribute='<form id="fake">
<input type="hidden" name="sid" value="88421b16df27c1004804c21861f32f84ca19fa67" /></form>' />
</form>
